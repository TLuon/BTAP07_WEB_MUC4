...
CREATE TABLE products (
  ...
  price FLOAT NOT NULL, stock INT NOT NULL DEFAULT 0, status INT NOT NULL DEFAULT 1,
  categoryId INT NULL FOREIGN KEY REFERENCES categories(categoryId)
);
...
INSERT INTO products(productName,description,price,stock,status,categoryId) VALUES
(N'iPhone 15 Pro',N'Điện thoại Apple',30000000,20,1,1),
(N'MacBook Air M3',N'Laptop mỏng nhẹ',29000000,15,1,2),
(N'AirPods Pro',N'Tai nghe không dây',5500000,50,1,3);
INSERT INTO product_images(imagePath, productId) VALUES
(N'https://placehold.co/400x250/0d6efd/ffffff?text=iPhone', 1),
(N'https://placehold.co/400x250/198754/ffffff?text=MacBook', 2),
(N'https://placehold.co/400x250/6f42c1/ffffff?text=AirPods', 3);
GO
